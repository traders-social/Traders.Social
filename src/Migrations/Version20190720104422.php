 ...
 */
final class Version20190720104422 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE enthusiast (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(255) NOT NULL, uuid VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, name VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_697AE07FE7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('INSERT INTO role VALUE (1, "Administrator", "Administrator role")');
        $this->addSql('INSERT INTO role VALUE (2, "Moderator", "Moderator role")');
        $this->addSql('INSERT INTO role VALUE (3, "User", "User role")');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE enthusiast');
